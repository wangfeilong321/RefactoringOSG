...
public:
	...
	///
	/// <remarks>	Administrator, 2015/5/6. </remarks>
	///
	...
	///-------------------------------------------------------------------------------------------------
	/// <summary>	Writes a PNG stream. </summary>
	///
	/// <remarks>	Administrator, 2015/5/6. </remarks>
	///
	/// <param name="fout">					[in,out] The fout. </param>
	/// <param name="img">					The image. </param>
	/// <param name="compression_level">	The compression level. </param>
	///
	/// <returns>	The WriteResult::WriteStatus. </returns>
	///-------------------------------------------------------------------------------------------------
	...
	WriteResult::WriteStatus writePngStream(std::ostream& fout, const osg::Image& img, int compression_level) const
	{
		...
		bitDepth = osg::Image::computePixelSizeInBits(img.getPixelFormat(), img.getDataType()) / osg::Image::computeNumComponents(img.getPixelFormat());
		...
		if (bitDepth > 8 && osg::getCpuByteOrder() == osg::LittleEndian) png_set_swap(png);
	...
	///-------------------------------------------------------------------------------------------------
	/// <summary>	Reads PNG stream. </summary>
	///
	/// <remarks>	Administrator, 2015/5/6. </remarks>
	///
	/// <param name="fin">	[in,out] The fin. </param>
	///
	...
	ReadResult readPNGStream(std::istream& fin) const
	{
...
#endif
		{
			...
			if (depth > 8 && osg::getCpuByteOrder() == osg::LittleEndian)
				png_set_swap(png);
	...
	///-------------------------------------------------------------------------------------------------
	/// <summary>	Gets compression level. </summary>
	///
	/// <remarks>	Administrator, 2015/5/6. </remarks>
	///
	...
	///-------------------------------------------------------------------------------------------------
	/// <summary>	Reads an image. </summary>
	///
	/// <remarks>	Administrator, 2015/5/6. </remarks>
	///
	/// <param name="fin">		 	[in,out] The fin. </param>
